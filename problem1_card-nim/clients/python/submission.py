...
class MyPlayer(Client):
    ...
    def __init__(self, port=5000):
        ...
        self.dp_value = dict()
        self.index = 0
        self.round = 1 #which round it is
    ...
    def generatemove(self, state):
        ...
        # preparation if this is the first round
        if self.index == 0: #index =0 means this is first round
            ...
            if self.player_num == 2:
                ...
                try:
                    ...
                    pass
        else: #2nd to n-th round
        # calculating the card my opponent played
        ...
        '''
         if in round 1-5, and if the current stone number state is bigger or equal to 68:
            I call the designated calculation based on my experimental observation
         otherwise,
            I call my dynamic programming function
            
         The reason is because only when stone is less or equal to 67, the calculation time is under 2 mins
         if the current stone number (which is state in our program) is bigger than 67
            it takes more than 2 mins to calculate the result by using dynamic programming
        '''
        if self.round == 1:
    ...
    def initialize_card_list(self, num_stone):
        ...
        print('initializing cards, total card number:', num_card)
