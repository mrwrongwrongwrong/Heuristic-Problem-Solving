...
def my_solution(pers, hosps):
    ...
    #     fil.write(op)
    print('my data is',read_data(fname="data.txt"))
    print('my data type is',type(read_data(fname="data.txt")))
    print('patients',read_data(fname="data.txt")[0])
    print('data type of patients', type(read_data(fname="data.txt")[0]))
    print('hopspitals',read_data(fname="data.txt")[1])

    print('first patients', read_data(fname="data.txt")[0][0])

    print('data type first patients', type(read_data(fname="data.txt")[0][0]))
    #print('first patients number', type(read_data(fname="data.txt")[0][0][1]))
    #print('data type first patients location and time', type(read_data(fname="data.txt")[0][0][1]))
    #print(' patients location', read_data(fname="data.txt")[0].tolist())
    print(' patients location', read_data(fname="data.txt")[0][0].pid, read_data(fname="data.txt")[0][0].x,read_data(fname="data.txt")[0][0].y, read_data(fname="data.txt")[0][0].st )
    return

def distance(p1, p2):
    #return np.sum((p1 - p2) ** 2)
    return math.sqrt(np.sum((p1.x - p2.x) ** 2 + (p1.y - p2.y) ** 2))
